...
tests.push({
  ...
  predicate: function($tr) {
    ...
    var payload = "HELLO";
    try {
      ws = io("wss://socket-io-test.liveoak.net/", {
        reconnection: true,
...
tests.push({
  ...
  predicate: function($tr) {
    ...
    try {
      ...
      consumer = ActionCable.createConsumer("wss://liveoak.dev:3000/cable");
      subscription = consumer.subscriptions.create("EchoChannel", {
